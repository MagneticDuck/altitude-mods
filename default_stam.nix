  ...
  default =
    mkMod {
      ...
      extraMaps = [
        ...
        {src = 1lhroids; name = "1lh_asteroids.altx";}
        {src = 1lhroids2; name = "1lh_asteroids2.altx";}
        {src = 1lhcave; name = "1lh_cave.altx";}
        {src = 1lhcave2; name = "1lh_cave2.altx";}
        {src = 1lhclocktower; name = "1lh_clocktower.altx";}
        {src = 1lhcore; name = "1lh_core.altx";}
        {src = 1lhfallout; name = "1lh_fallout.altx";}
        {src = 1lhgrotto; name = "1lh_grotto.altx";}
        {src = 1lhlocomotion; name = "1lh_locomotion.altx";}
        {src = 1lhmayhem; name = "1lh_mayhem.altx";}
        {src = 1lhmayhem2; name = "1lh_mayhem2.altx";}
        {src = 1lhmaze; name = "1lh_maze";}
        {src = 1lhmetropolis; name = "1lh_metropolis.altx";}
        {src = 1lhmiddleground; name = "1lh_middleground";}
        {src = 1lhplanepark; name = "1lh_planepark.altx";}
        {src = 1lhslick; name = "1lh_slick.altx";}
        {src = 1lhtwisted; name = "1lh_twisted.altx";}
        {src = 1lh_underpark; name = "1lh_underpark.altx";}
        {src = 1lhwoods; name = "1lh_woods.altx";} 
      ];
    };
      ...
      launcherConfig =
        mkLauncherConfig {
          ...
          maps = ["|1dm|" "|ball|" "|1de|" "|tdm|" "ball_arrow" "ball_race_asteroids" "ball_race_eastern_creek" "ball_antre_pb" "ball_cave_pb"
				  ...
				  "1lh_middleground" "1lh_planepark" "1lh_slick" "1lh_twisted" "1lh_underpark" "1lh_woods" "ball_tron"];
          admins = tbgAdmins;
        };
      extraMaps = [
